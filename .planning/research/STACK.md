...
npm install -D typescript@7.0.2 @google/clasp@3.3.0 vite@8.1.4 vite-plugin-singlefile@2.3.3 @types/google-apps-script@2.0.11 @tailwindcss/vite@4.3.2

# Production / Client dependencies (Bundled by Vite)
npm install tailwindcss@4.3.2 @telegram-apps/sdk@3.11.8 chart.js@4.5.1
```
...
**If Vanilla JS (No Build Tooling preferred):**
...
**If Production-grade TypeScript (Recommended):**
